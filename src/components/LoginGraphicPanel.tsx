...
import { MessageCircle, Heart, ShieldCheck, Lock, Sparkles as SparklesIcon } from 'lucide-react'

const FEATURES = [
  { icon: MessageCircle, titleKey: 'login.featureAlwaysTitle', descKey: 'login.featureAlwaysDesc' },
